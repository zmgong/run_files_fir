#!/bin/bash
#SBATCH -J 4_loss_ablation_sum_a100
...
srun python scripts/train_cl.py 'model_config=for_bioscan_5m/hyperbolic/intra_level_exp/ablation_loss_func/a100/4_loss_ablation_sum_a100.yaml' bioscan_5m_data.path_to_hdf5_data=$SLURM_TMPDIR/BIOSCAN_5M.hdf5