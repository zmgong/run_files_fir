#!/bin/bash
#SBATCH -J SEL_ver2_0_1_5ep_eval_fir
#SBATCH --gpus-per-node=h100:4
#SBATCH --time=23:59:00
#SBATCH --output=logs/SEL_final_exp_ver_2/0_1_baseline_5epoch_eval_each_epoch.output
#SBATCH --nodes=1
...
cfg="0_1_baseline_common_deepest_5epoch_eval_each_epoch"
