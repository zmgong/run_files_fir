#!/bin/bash
#SBATCH -J SEL_ver2_0_2_10ep_eval_fir
#SBATCH --gpus-per-node=h100:4
#SBATCH --time=23:59:00
#SBATCH --output=logs/SEL_final_exp_ver_2/0_2_baseline_10epoch_eval_each_epoch.output
#SBATCH --nodes=1
...
cfg="0_2_baseline_common_deepest_10epoch_eval_each_epoch"
