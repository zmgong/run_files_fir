...
declare -A TASK_SCRIPT=(
  ...
  ["4a_mean_with_batch_size_clw_0_1"]="run_SEL_final_exp_ver_2_task_4a_mean_with_batch_size_clw_0_1_fir.sh"
  ["4b_mean_with_batch_size_clw_0_3"]="run_SEL_final_exp_ver_2_task_4b_mean_with_batch_size_clw_0_3_fir.sh"
  ["4c_mean_with_batch_size_clw_1_0"]="run_SEL_final_exp_ver_2_task_4c_mean_with_batch_size_clw_1_0_fir.sh"
)
...
TASKS_ORDER=(
  ...
  "run_SEL_final_exp_ver_2_task_4a_mean_with_batch_size_clw_0_1_fir.sh"
  "run_SEL_final_exp_ver_2_task_4b_mean_with_batch_size_clw_0_3_fir.sh"
  "run_SEL_final_exp_ver_2_task_4c_mean_with_batch_size_clw_1_0_fir.sh"
)
