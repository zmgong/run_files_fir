#!/bin/bash
#SBATCH -J SEL_euclidean_cl_common_deepest_dna_bin
...
cfg="euclidean_cl_two_stage_common_deepest_with_dna_bin"
...
CONFIG_BASE="model_config=for_bioscan_5m/hyperbolic/cl_ablation"
CONFIG_DIR_REL="bioscanclip/config/model_config/for_bioscan_5m/hyperbolic/cl_ablation"
